...
5. **Use an isolated agent-browser session** to avoid conflicts with other Codex sessions or parallel tracks. Generate a unique session name at the start:
   ```bash
...
|---|---|
| `paas_rag` | `.Codex/skills/paas-rag-test-coverage/` |
| `enterprise_rag` | `.Codex/skills/enterprise-rag-test-coverage/` |
| `enterprise_rag_aiq` | `.Codex/skills/enterprise-rag-test-coverage/` |
| `cuopt` | `.Codex/skills/cuopt-test-coverage/` |
| `vss` | `.Codex/skills/vss-test-coverage/` |
| `dox_pack` | `.Codex/skills/dox-pack-test-coverage/` |
...
> **JUST-IN-TIME LOADING:** Read `.Codex/skills/<category>-test-coverage/infra-tests.md` NOW. This file is self-contained — it has every infrastructure test with kubectl/OCI CLI commands, expected output, and failure hints. Execute directly from it.
...
> **JUST-IN-TIME LOADING:** Read `.Codex/skills/<category>-test-coverage/api-tests.md` NOW. This file is self-contained — it has every API test with endpoint, method, request body, verification criteria, and curl commands. Execute directly from it.
...
> **JUST-IN-TIME LOADING:** Read `.Codex/skills/<category>-test-coverage/ui-tests.md` NOW. This file is self-contained — it has every UI test with agent-browser commands, interaction steps, and verification criteria. Execute directly from it.
