      ...
      deployments = [
        {
          ...
          recipe = {
            ...
            recipe_image_uri                      = "iad.ocir.io/iduyx1qnmway/corrino-devops-repository/warehouse-pick-path-optimizer-be:9146496"
            recipe_replica_count                  = 1
            recipe_node_shape                     = local.starter_pack_config.worker_node_shape
            recipe_nvidia_gpu_count               = 1
            recipe_use_shared_node_pool           = true
          ...
          recipe = merge(
            {
              ...
              recipe_image_uri                     = "iad.ocir.io/iduyx1qnmway/corrino-devops-repository/warehouse-pick-path-optimizer-fe:9146496"
              recipe_replica_count                 = 1
