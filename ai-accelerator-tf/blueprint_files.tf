      ...
      "deployments" : [
        ...
        },
        {
          ...
          "recipe" : {
            ...
            "recipe_environment_secrets" : [
              {
                "envvar_name" : "DB_USERNAME",
                "secret_name" : "neo4j-creds",
                "secret_key" : "username"
              },
              {
        ...
        },
        {
          ...
          "recipe" : {
            ...
            "recipe_environment_secrets" : [
              {
                ...
                "secret_name" : "ngc-api-key-secret",
            ...
            "pvcs" : {
              ...
              "volumes" : [
                {
                  "name" : "nemo-embed-cache",
                  "mount_location" : "/mnt/nim-cache",
        ...
        },
        {
          ...
          "recipe" : {
            ...
            "recipe_container_env" : [
              ...
              {
                "key" : "NIM_MAX_MODEL_LEN",
                "value" : "32768"
              },
              {
                "key" : "TRTLLM_KVCACHE_FREE_GPU_MEM_FRACTION",
                "value" : "0.7"
              }
            ],
            "recipe_environment_secrets" : [
        ...
        },
        {
          ...
          "recipe" : {
            ...
            "service_endpoint" : {
              "dedicated_load_balancer" : true
            },
            "recipe_additional_ingress_ports" : [
              { "name" : "frontend", "port" : 9000, "path" : "/" }
            ],
            "recipe_container_command" : ["bash", "/opt/scripts/start.sh"],
            "recipe_shared_memory_volume_size_limit_in_mb" : 16384,
            ...
            "pvcs" : {
              ...
              "volumes" : [
                {
                  "name" : "vss-ngc-model-cache",
                  "mount_location" : "/tmp/via-ngc-model-cache",
                  "volume_size_in_gbs" : 1000
                }
              ]
            },
            ...
            "recipe_environment_secrets" : [
              ...
              {
                "envvar_name" : "GRAPH_DB_USERNAME",
                "secret_name" : "neo4j-creds",
                "secret_key" : "username"
              },
              {
                "envvar_name" : "GRAPH_DB_PASSWORD",
                "secret_name" : "neo4j-creds",
                "secret_key" : "password"
              },
              {
                "envvar_name" : "MINIO_USERNAME",
                "secret_name" : "minio-creds-secret",
                "secret_key" : "access-key"
              },
              {
                "envvar_name" : "MINIO_PASSWORD",
                "secret_name" : "minio-creds-secret",
                "secret_key" : "secret-key"
              },
              {
                "envvar_name" : "ARANGO_DB_USERNAME",
                "secret_name" : "arango-db-creds-secret",
                "secret_key" : "username"
              },
              {
                "envvar_name" : "ARANGO_DB_PASSWORD",
                "secret_name" : "arango-db-creds-secret",
                "secret_key" : "password"
              }
            ],
