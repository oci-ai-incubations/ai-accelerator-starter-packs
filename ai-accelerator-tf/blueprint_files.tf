          ...
          recipe = merge(
            {
              ...
              recipe_container_env = [
                ...
                { key = "VIA_VLM_ENDPOINT", value = "https://openrouter.ai/api/v1/" },
                { key = "VIA_VLM_OPENAI_MODEL_DEPLOYMENT_NAME", value = "qwen/qwen3-vl-235b-a22b-thinking" },
                { key = "DISABLE_GUARDRAILS", value = "true" },
                { key = "OPENAI_API_KEY", value = "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" },
                ...
                { key = "LLM_BASE_URL", value = "https://openrouter.ai/api/v1/" },
                { key = "LLM_MODEL", value = "qwen/qwen3-vl-235b-a22b-thinking" },
